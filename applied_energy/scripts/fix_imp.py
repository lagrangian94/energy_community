...
def main():
    ...
    parser.add_argument('--input', type=str, default=_os.path.join(_RESULTS, 'results_53/low_h2_margin.csv'),
                        help='입력 CSV 경로')
    parser.add_argument('--output', type=str, default=_os.path.join(_RESULTS, 'results_53/low_h2_margin.csv'),
